...
CREATE INDEX "fkIdx_73" ON "voteringar"
(
 "person_id"
);
...
CREATE INDEX "fkIdx_20" ON "anforandetext"
(
 "person_id"
);
...
CREATE INDEX "fkIdx_84" ON "resultat_votering"
(
 "voterings_id",
 "person_id"
);
...
CREATE INDEX "fkIdx_31" ON "resultat_sentiment"
(
 "anforande_id"
);
