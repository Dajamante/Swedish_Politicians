...
def main():
    ...
    test_targets = [model.emotions[0],model.emotions[0],model.emotions[2],model.emotions[1],model.emotions[2]]
    ##===============================
    ...
    text_clf = model.building_pipeline(SGDClassifier,test_sentances = test_sentances , test_targets = test_targets)
